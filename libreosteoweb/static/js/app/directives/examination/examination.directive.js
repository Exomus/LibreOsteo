...
angular
    ...
    .directive('examination', ['ExaminationServ', 'PatientServ', 'TherapeutSettingsServ', 'OfficeSettingsServ', function(ExaminationServ, PatientServ, TherapeutSettingsServ, OfficeSettingsServ) {
    "use strict";
    return {
        restrict: 'E',
        scope: {
